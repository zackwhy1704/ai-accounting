...
import { useCreateProduct, useTaxRates, useAccounts } from "../../lib/hooks"
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 py-8">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-bold text-foreground">New Product / Service</h1>
        <p className="mt-1 text-sm text-muted-foreground">Add a new item to your product catalog</p>
      </div>
        ...
        <div className="grid gap-5">
          ...
          {productType === "inventory" && (
            <div className="space-y-3 rounded-xl border border-border bg-muted/30 p-4">
              ...
              {trackInventory && (
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-foreground">Opening Quantity</label>
