...
export default function NewStockAdjustmentPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast("Stock adjustment created", "success")
      navigate("/stock/adjustments")
    },
    onError: () => toast("Failed to create adjustment", "warning"),
  })
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <div className="mt-1 text-2xl font-semibold tracking-tight text-foreground">New Stock Adjustment</div>
        <div className="mt-1 text-sm text-muted-foreground">Adjust stock quantities for your products</div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button
            type="submit"
            disabled={mutation.isPending || !form.adjustment_date}
