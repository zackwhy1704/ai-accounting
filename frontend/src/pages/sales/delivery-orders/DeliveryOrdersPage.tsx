                      ...
                      <TableRow key={d.id} className="border-border hover:bg-muted/50">
                        ...
                        <TableCell className="text-right">
                          <div className="relative" ref={menuRef}>
                            <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground" onClick={() => setOpenMenu(openMenu === d.id ? null : d.id)}>
                            ...
                            {openMenu === d.id && (
                              <div className="absolute right-0 top-8 z-50 w-56 rounded-xl border border-border bg-card p-1 shadow-lg" onMouseLeave={() => setOpenMenu(null)}>
                                <button className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-xs text-foreground hover:bg-muted">
                                  <Copy className="h-3.5 w-3.5" /> {t("deliveryOrders.duplicate")}
                                </button>
                                <button className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-xs text-foreground hover:bg-muted">
                                  <FileText className="h-3.5 w-3.5" /> {t("deliveryOrders.printPdf")}
                                </button>
                              </div>
                            )}
                          </div>
