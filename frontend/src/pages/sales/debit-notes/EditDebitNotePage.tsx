    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-end">
        <div className="flex items-center gap-3">
          ...
          <Button type="button" onClick={handleSave} disabled={updateDebitNote.isPending || !customerId || !lines.some((l: any) => l.description?.trim()) || !lines.every((l: any) => l.accountId)} className="h-9 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 text-xs font-semibold text-white shadow-sm hover:opacity-95">
