...
import { useSaleReceipt, useUpdateSaleReceipt, useContacts, useBankAccounts, useTaxRates, useSaleReceiptActivity, type InvoiceActivityEvent } from "../../../lib/hooks"
...
export default function EditSaleReceiptPage() {
  ...
  const { data: activity } = useSaleReceiptActivity(id)
