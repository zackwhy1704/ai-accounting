...
import { LineItemsEditor, useLineItems, type LineItem } from "../../../components/line-items"
...
export default function EditCreditNotePage() {
  ...
  useEffect(() => {
    ...
    if (creditNote.line_items?.length) {
      setLineItems(creditNote.line_items.map((l: any): LineItem => ({
        ...
        discount_mode: l.discount_mode === "amount" ? "amount" : "percent",
        tax_rate: l.tax_rate ?? 0,
        line_type: l.line_type === "services" ? "services" : "goods",
