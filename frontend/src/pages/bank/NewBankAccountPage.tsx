...
export default function NewBankAccountPage() {
  ...
  const mutation = useMutation({
    ...
    onError: () => toast("Failed to create bank account", "warning"),
  })
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <div className="mt-1 text-2xl font-semibold tracking-tight text-foreground">New Bank Account</div>
        <div className="mt-1 text-sm text-muted-foreground">Add a bank or cash account to track transactions</div>
      </div>
