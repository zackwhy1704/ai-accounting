...
export default function NewBankTransferPage() {
  ...
  const mutation = useMutation({
    mutationFn: async (data: TransferForm) => {
      const res = await api.post("/bank-transfers", {
        ...data,
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <div className="mt-1 text-2xl font-semibold tracking-tight text-foreground">New Bank Transfer</div>
        <div className="mt-1 text-sm text-muted-foreground">Transfer funds between your bank accounts</div>
      </div>
