...
import { useContacts, useAccounts, useBill, useUpdateBill, useTaxRates, useBillActivity, useBillJournalEntries, type InvoiceActivityEvent } from "../../lib/hooks"
...
export default function EditBillPage() {
  ...
  const { data: billJournalData, isLoading: billJournalLoading } = useBillJournalEntries(id)
        ...
        <Card className="rounded-2xl border-border bg-card p-6 shadow-sm">
          <Tabs defaultValue="history">
            ...
            <TabsContent value="journal">
              <JournalEntriesPanel groups={billJournalData?.journal_entries} isLoading={billJournalLoading} />
            </TabsContent>
          </Tabs>
        </Card>
      )}
