...
import { useContacts, useCreatePurchasePayment } from "../../lib/hooks"
...
export default function NewPurchasePaymentPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast("Failed to record payment", "warning")
    }
  }
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1">
        ...
        <div className="text-2xl font-semibold tracking-tight text-foreground">Record Payment to Supplier</div>
      </div>
